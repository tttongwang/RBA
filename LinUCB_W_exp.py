...
#             avg_output_ot_bw.to_csv("result/LinUCB_bias_" + 'lambda_' + str(fixed_lambda) +".csv")
#             avg_output_ot_sw = pd.DataFrame(std_list_W)
#             avg_output_ot_sw.to_csv("result/LinUCB_std_" + 'lambda_' + str(fixed_lambda) +".csv")
...
avg_output_ot_bw = pd.DataFrame(bias_list_W)
avg_output_ot_bw.to_csv("result/LinUCB_bias_W" +".csv")
avg_output_ot_sw = pd.DataFrame(std_list_W)
avg_output_ot_sw.to_csv("result/LinUCB_std_W" +".csv")
