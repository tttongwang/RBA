...
png("uneq_linucb_c2.png", units="in", width=5, height=3, res=300)


uneq_lingd_bias        <- read_excel("uneq_linucb_bias_c2.xlsx")
...
uneq_lingd_std         <- read_excel("uneq_linucb_std_c2.xlsx")
